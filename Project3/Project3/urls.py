...
from django.contrib.auth.views import LoginView, logout_then_login, PasswordResetView, PasswordChangeDoneView, \
    PasswordResetConfirmView, PasswordResetCompleteView
urlpatterns = [
    path('admin/', admin.site.urls),
    path('inCharge/', include(('inCharge.urls', 'inCharge'), namespace='inCharge')),
    ...
    path('reset/password_reset_done/', PasswordChangeDoneView.as_view(
